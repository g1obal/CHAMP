...
!     tcsq=eerr/eerr1
      ...
      eloc_tc (1) = tcsq**2 !JT
      sigma=eer1s*rtpass ! CJU restored 25 Jan 2026, but I am not sure if it is right or why it was commented

      call object_modified ('eerr')  !JT
      call object_modified ('sigma') !JT ! CJU restored 25 Jan 2026, but I am not sure if it is right or why it was commented
